...
from  one_fm.overrides.payment_entry import add_party_gl_entries_,get_valid_reference_doctypes_,validate_allocated_amount_


__version__ = '14.4.2'

PaymentEntry.add_party_gl_entries = add_party_gl_entries_
PaymentEntry.validate_allocated_amount = validate_allocated_amount_
